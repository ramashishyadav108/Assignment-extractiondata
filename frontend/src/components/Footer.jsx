      ...
      <div className="footer-container">
        ...
        <div className="footer-top">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li>
                <a href="/health" className="footer-link" target="_blank" rel="noopener noreferrer">
                  <svg className="link-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="footer-section">
            ...
            <div className="tech-stack">
              ...
              {/* <div className="tech-item">
                <span className="tech-icon">📊</span>
                <span className="tech-name">Excel</span>
              </div> */}
            </div>
          </div>
          ...
          <div className="footer-section">
            ...
            <div className="contact-info">
              <a href="mailto:support@pdfextractor.com" className="contact-item">
                <svg className="contact-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                support@pdfextractor.com
              </a>
        ...
        <div className="footer-bottom">
          <div className="copyright">
            <p>© {currentYear} PDF Extractor. All rights reserved.</p>
          </div>
